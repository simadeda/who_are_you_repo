...
public class Script_principale_menu_nazione : MonoBehaviour
{
    ...
    {           
        ...
        num_rnd = Random_number1.Rnd(n_stati);
        ...
        lettoreXMLscript.Lettura_abilità_stato(num_rnd, nome_continente, out nome_abilita_stato);
        num_rnd = Random_number1.Rnd(7);
        //scelta tramite il numero random della classe e della sua relativa abilità base
        lettoreXMLscript.Lettura_abilita_classe(num_rnd, out nome_classe, out nome_abilita_classe);
